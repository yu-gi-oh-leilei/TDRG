...
try:
    from trans_utils.transformer_encoder import TransformerEncoder, TransformerEncoderLayer
    from trans_utils.transformer_decoder import TransformerDecoder, TransformerDecoderLayer
    from trans_utils.misc import _get_clones, _get_activation_fn
except ImportError:
